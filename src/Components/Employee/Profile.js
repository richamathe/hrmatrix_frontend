        ...
        <div className="row g-3">
          ...
          <div className="col-md-6 mb-3">
            <div className="d-flex align-items-center">
              ...
              <div>
                <p style={{ fontSize: '0.8rem', color: themeColors.lightText, marginBottom: '2px' }}>Mobile</p>
                <p style={{ fontWeight: '500', color: themeColors.darkText, fontSize: '0.95rem' }}>{user?.mobile}</p>
              </div>
            </div>
          </div>
          ...
          <div className="col-md-6 mb-3">
            <div className="d-flex align-items-center">
              ...
              <div>
                ...
                <p style={{ fontWeight: '500', color: themeColors.darkText, fontSize: '0.95rem' }}>{user?.address || 'Not provided'}</p>
              </div>
            </div>
          </div>
          ...
          <div className="col-md-6 mb-3">
            <div className="d-flex align-items-center">
              ...
              <div>
                <p style={{ fontSize: '0.8rem', color: themeColors.lightText, marginBottom: '2px' }}>Join Date</p>
          ...
          <div className="col-md-6 mb-3">
            <div className="d-flex align-items-center">
              ...
              <div>
                <p style={{ fontSize: '0.8rem', color: themeColors.lightText, marginBottom: '2px' }}>Gender</p>
                <p style={{ fontWeight: '500', color: themeColors.darkText, fontSize: '0.95rem' }}>{user?.gender}</p>
              </div>
            </div>
          </div>
          ...
          <div className="col-md-6 mb-3">
            <div className="d-flex align-items-center">
              ...
              <div>
                <p style={{ fontSize: '0.8rem', color: themeColors.lightText, marginBottom: '2px' }}>Date of Birth</p>
                <p style={{ fontWeight: '500', color: themeColors.darkText, fontSize: '0.95rem' }}>{formatDate(user?.dob)}</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="row g-3">
          ...
          <div className="col-md-6 mb-3">
            <div className="d-flex align-items-center">
              ...
              <div>
                <p style={{ fontSize: '0.8rem', color: themeColors.lightText, marginBottom: '2px' }}>Designation</p>
                <p style={{ fontWeight: '500', color: themeColors.darkText, fontSize: '0.95rem' }}>{user?.designation}</p>
              </div>
            </div>
          </div>
        </div>
